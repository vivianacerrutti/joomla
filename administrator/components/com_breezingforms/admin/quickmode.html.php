		            	...
		            	<div class="bfProperties" id="bfElementProperties" style="display:none">
		            		...
		            		<fieldset>
		            			...
		            			<div class="bfElementTypeClass" id="bfElementTypeTextarea" style="display:none">
			            			...
			            			<br/>
			            			<br/>
                                                        <label class="bfPropertyLabel" for="bfElementTypeTextareaIsHtml">HTML</label>
		            		...
		            		<fieldset id="bfValidationScript" style="display:none">
		            			...
		            			<div>
									...
									<div id="bfValidationScriptLibrary" style="display:none">
										<hr/>
										<?php echo BFText::_('COM_BREEZINGFORMS_SCRIPT') ?>:<br/> <select id="bfValidationScriptSelection"></select>
										<br/>
										<br/>
                                                                                <br/>
		            	...
		            	<div class="bfAdvanced" id="bfFormAdvanced" style="display:none">
			            	...
			            	<fieldset>
			            		...
			            		<br/>
                                                ...
                                                <input type="hidden" value="" id="bfElementAdvancedForceMobileUrl"/>
			            		...
			            		<br/>
                                                ...
                                                ?>
                                                <input type="hidden" value="" id="bfElementAdvancedJoomlaHint"/>
                                                <?php
                                                }
                                                ?>
