...
?>
		...
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="<?php echo version_compare($version->getShortVersion(), '3.0', '>=') ? 'width:100%;' : 'width:780px;'; ?>">
...
?>
			<table width="80%" class="adminlist table table-striped">
			<tr>
				...
				<td nowrap>
					<table cellpadding="0" cellspacing="0" border="0">
						<tr id="emailaddress"<?php if ($row->emailntf!=2) echo ' style="display:none;"'; ?>>
							...
							<td><input type="text" size="50" name="emailadr" value="<?php echo $row->emailadr; ?>" class="inputbox"/></td>
						</tr>
...
?>
                <table width="80%" class="adminlist table table-striped">
			<tr>
                            <td  width="30%" valign="top" nowrap><?php echo BFText::_('COM_BREEZINGFORMS_FORMS_EMAILNOTIFY'); ?>:</td>
...
?>
                ...
                <table border="0" width="100%" class="adminlist table table-striped">

                                            <tr>
                                                <td width="30%"><?php echo BFText::_('COM_BREEZINGFORMS_API_KEY'); ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" name="mailchimp_mergevars"  value="<?php echo $row->mailchimp_mergevars; ?>" style="width:90%;"  class="inputbox"/></td>
                                            </tr>
