...
<?php } ?>
        ...
        <div class="maxiroundedcenter">
            ...
            $logofloat = ($params->get('orientation', 'horizontal') == 'vertical') ? '' :  'style="float: '.$params->get('logoposition','left').';';
            $styles = $logofloat . 'margin: '.$params->get('logomargintop','0').'px '.$params->get('logomarginright','0').'px '.$params->get('logomarginbottom','0').'px '.$params->get('logomarginleft','0').'px"';
