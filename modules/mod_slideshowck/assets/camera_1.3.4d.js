...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		transPeriod			: 1500,	//lenght of the sliding effect in milliseconds
                ...
                fullpage			: false,	//lenght of the sliding effect in milliseconds
...
////////callbacks
	...
	for (loopMove=0;loopMove<amountSlide;loopMove++)
	{
		...
		if(allLinks[loopMove]!=''){
			...
			$('.camera_target_content .cameraContent:eq('+loopMove+')',wrap).append('<a class="camera_link" '+allRels[loopMove]+'href="'+allLinks[loopMove]+'" '+dataBox+' target="'+allTargets[loopMove]+'"></a>');
		}
