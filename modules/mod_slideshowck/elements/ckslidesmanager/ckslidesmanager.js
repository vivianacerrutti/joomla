...
function addslideck(imgname, imgcaption, imgthumb, imglink, imgtarget, imgvideo, slideselect, imgalignment, articleid, imgtime) {
    ...
    ckslide.set('html','<div class="ckslidehandle"><div class="ckslidenumber">'+index+'</div></div><div class="ckslidecontainer">'
        ...
        + '</div>'
        + '<div class="ckslideaccordeoncontent">'
        + '<div class="cksliderow"><span class="ckslidelabel">'+Joomla.JText._('MOD_SLIDESHOWCK_ARTICLE_ID', 'Article ID')+'</span><input name="ckslidearticleid'+index+'" class="ckslidearticleid" type="text" value="'+articleid+'" onchange="javascript:storesetwarning();" /></div>'
        + '</div>'
        + '</div></div>'
